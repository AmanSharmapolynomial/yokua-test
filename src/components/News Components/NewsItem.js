        ...
        >
          ...
          <div className="yk-attached-file">
            {editView ? (
              hasPermission && (
                <>
                <div className="inputfile-box " style={{
                  display: 'flex',
                  flexDirection: 'column-reverse',
                }}>
                  <div>
                  <i className="fa-solid fa-paperclip yk-icon-hover" style={{ fontSize: '22px' }} onClick={() => fileInputRef.current.click()}/>
                  <input
