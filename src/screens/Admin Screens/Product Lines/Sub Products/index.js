  ...
  return (
    <>
      <div className="container">
        <Breadcrumb previousPages={state.previousPage} currentPage={'Sub Products'} />
        <h2 className={'sub-header'}>{state.header}</h2>
        ...
        <div className="img-section mb-5 ">
          {productList.map((item, index) => (
            ...
            >
              ...
              <div className="img-bottom">{item.sub_product_name}</div>
            </div>
          ))}
        </div>
      </div>
