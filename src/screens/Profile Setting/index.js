        ...
        <div className="profile-setting">
          ...
          <div className="profile-setting__basic-profile profile-setting__box">
            ...
            <div className="profile-setting__basic-profile-edit">
              ...
              <div className="edit_input">
                ...
                <input type="text" name="name" value="michaeljordan@yokogawa.com" />
                <i className="fa-solid fa-pen-to-square edit"></i>
              </div>
              <div className="edit_input">
                <i className="fa-solid fa-house-chimney" />
                <input type="text" name="name" value="Rota Yokogawa GmbH & Co. KG" />
                <i className="fa-solid fa-pen-to-square edit"></i>
              </div>
            </div>
          </div>
          ...
          <div className="profile-setting__basic-profile profile-setting__box">
            ...
            <div className="profile-setting__basic-profile-edit">
              ...
              <div className="edit_input">
                <i className="fa-solid fa-unlock" />
                <input type="text" name="name" placeholder="Retype New Password" />
                <i className="fa-solid fa-pen-to-square edit" />
              </div>
            </div>
          </div>
            ...
            <div className="sales-news_background">
              <div className="profile-setting__sales-news ">
                <div className="edit_sales-news">
                  ...
                  <label for="check1"> Recieve all news via E-mail</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check2" name="check2" />
                  <label for="check2">Flowmeter news</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check3" name="check3" />
                  <label for="check3">Pressure Transmitter news</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check4" name="check4" />
                  <label for="check4">Flow Configurator news</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check4" name="check4" />
                  <label for="check4">Lead-Time news</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check4" name="check4" />
                  <label for="check4">Events & Trainings</label>
                </div>
                <div className="edit_sales-news specific">
                  <input type="checkbox" id="check4" name="check4" />
                  <label for="check4">Company news & Others</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="events_trainings">
            <div className="profile-setting__basic-profile profile-setting__box registered_events">
              ...
              <div className="profile-setting__basic-profile-edit">
                <div className="edit_training">
                  <i className="fa-solid fa-calendar-check" />
                  <div className="training_text">
                    <span>Flow Focus Training</span>
                    <span>05 May - 08 May 2021</span>
                    <span>Latest cancellation date 01 May 2021</span>
                  </div>
                ...
                <div className="edit_training">
                  <i className="fa-solid fa-calendar-check" />
                  <div className="training_text">
                    <span>Rota Yokogawa GmbH & Co. KG</span>
                  </div>
                  <i className="fa-solid fa-pen-to-square edit" />
                </div>
              </div>
