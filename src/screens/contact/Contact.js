                ...
                <div className="col-md-3 col-lg-3 col-xl-3">
                  <div className="cont-detail mt-2">
                    <i className="fa fa-home mb-4" aria-hidden="true">
                      &nbsp; &nbsp;<span className="sm-h">Rota yokogawa .gbh </span>
                    </i>
                    <i className="fa fa-address-book mb-4" aria-hidden="true">
                      &nbsp; &nbsp;<span className="sm-h">Address</span>
                    </i>
                    <i className="fa fa-phone mb-4" aria-hidden="true">
                      &nbsp; &nbsp; <span className="sm-h">Phone</span>
                    </i>
                        ...
                        <div className="Product-item-deatail">
                          <div className="product-item-name">
                            ...
                            <i className="fa fa-envelope d-flex mt-4" aria-hidden="true">
                              <span className="sm-txt ml-2"> Rotamass.info@de.yokogawa.com</span>
                            </i>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-md-6 col-lg-6 col-xl-6">
                    <div className="d-flex">
                      ...
                      <div className="pmk-product-detail">
                        <div>
                          <i className="fa fa-user" aria-hidden="true"></i> &nbsp;Jean Michal Reboud
                        </div>
                        <div>
                          <i className="fa fa-phone" aria-hidden="true"></i> &nbsp;
                          <span className="px-2 py-1 border border-dark ">+01 2673674899</span>
                        </div>
                      </div>
                    </div>
                  </div>
